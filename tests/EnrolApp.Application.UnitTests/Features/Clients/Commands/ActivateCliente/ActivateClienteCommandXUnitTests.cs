...
using WebApiTest.Application.Features.Clients.Specifications;
using WebApiTest.Application.Features.Clients.Commands.ActivateCliente;
using WebApiTest.Domain.Entities.Common;
using WebApiTest.Domain.Entities.Nomina;
using WebApiTest.Domain.Entities.Suscripcion;
...
namespace WebApiTest.Application.UnitTests.Features.Clients.Commands.ActivateCliente;
